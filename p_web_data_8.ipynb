{
 "cells": [
   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       "'C:\\\\Users\\\\yesun\\\\tutorial\\\\tutorial\\\\spiders'"
      ]
     },
     "execution_count": 59,
     "metadata": {},
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Overwriting ds_web_data_paging.py\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "!scrapy runspider quotes_spider.py -o quotes_spider.json -t json --logfile quotes_spider.logfile"
   ]
  },
  {
   "cell_type": "code",
